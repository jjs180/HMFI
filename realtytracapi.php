...
if( $searchResult != false){    //Property in SF Found
    ...
    //Owner 1 response
    $labelname = properCase($propertyArr[0]["_OWNER"][0]["@_Name"]);
    ...
    $lastname2 = properCase($propertyArr[0]["_OWNER"][1]["_PARSED_NAME_ext"]["@_LastName"]);
    $firstname2 = properCase($propertyArr[0]["_OWNER"][1]["_PARSED_NAME_ext"]["@_FirstName"]);
    $middlename2 = properCase($propertyArr[0]["_OWNER"][1]["_PARSED_NAME_ext"]["@_MiddleName"]);
